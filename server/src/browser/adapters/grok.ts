...
const SEL = {
  newChatButton: 'a[href="/"], button[aria-label*="New chat" i], button:has-text("New Chat")',
  inputBox: 'textarea, div[contenteditable="true"]',
  sendButton: 'button[aria-label*="Send" i], button[type="submit"]',
  assistantMessage: '[data-testid="conversation-turn-assistant"], article[data-author="assistant"], .message-assistant',
}
